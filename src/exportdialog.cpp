    ...
    : QDialog(par, f)
{
    ...
    connect(sessions,
            ...
            this,
            SLOT(slot_activated(const QModelIndex &)));
    connect(sessions,
            SIGNAL(doubleClicked(const QModelIndex &)),
            this,
            SLOT(slot_dclicked(const QModelIndex &)));
    loadSessions();
}
...
void ExportDialog::loadSessions()
{
    ...
    QString exports = st.setting()->value(sessionId + "/export", (QVariant) QString()).toString();
...
{
    directory = QString();
    directory = QFileDialog::getExistingDirectory(this, tr("Select folder"), QDir::homePath());
