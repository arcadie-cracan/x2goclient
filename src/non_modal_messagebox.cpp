...
void Non_Modal_MessageBox::critical(QWidget *parent,
                                    const QString &title,
                                    const QString &text,
                                    ...
                                    QMessageBox::StandardButton defaultButton)
{
    ...
    QSpacerItem *horizontal_spacer = new QSpacerItem(500,
                                                     0,
                                                     QSizePolicy::Minimum,
                                                     QSizePolicy::Expanding);
    QGridLayout *grid_layout = (QGridLayout *) (msg_box->layout());
    grid_layout->addItem(horizontal_spacer,
                         grid_layout->rowCount(),
                         0,
                         1,
                         grid_layout->columnCount());
...
void Non_Modal_MessageBox::critical(QWidget *parent,
                                    ...
                                    QMessageBox::StandardButton defaultButton)
{
    Non_Modal_MessageBox::critical(parent,
                                   title,
                                   text,
                                   informative_text,
                                   false,
