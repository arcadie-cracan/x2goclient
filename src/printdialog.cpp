    ...
    : QDialog(parent, f)
{
    ...
    ui.setupUi(this);
    ui.buttonBox->button(QDialogButtonBox::Ok)->setText(tr("Print"));
    ...
    connect(pwidg, SIGNAL(dialogShowEnabled(bool)), this, SLOT(slot_dlgShowEnabled(bool)));
}
...
void PrintDialog::slot_dlgShowEnabled(bool enable)
{
    if (!enable)
        QMessageBox::warning(this,
                             tr("You've deactivated the X2Go "
